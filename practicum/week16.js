...
function makeTwo() {
  ...
  paragraphTwo.textContent = form1.getAttribute("name");
}
...
function makeFive() {
  ...
  const form3Elements = form3.elements.length;
  paragraphFive.textContent = form3Elements;
}
...
function makeSix() {
  ...
  const form2Elements = form2.elements.length;
  paragraphSix.textContent = form2Elements;
}
...
function makeSeven() {
  ...
  let elenemtsList;
  for (let element of form2Elements) {
    const elemetnName = element.getAttribute("name");
    elenemtsList += ` -${elemetnName}`;
  }
  paragraphSeven.textContent = elenemtsList;
}
...
function makeEight() {
  ...
  let elementslist;
  for (let element of form1) {
    const elementName = element.getAttribute("name");
    elementslist += ` ${elementName} `;
  }
  paragraphEight.textContent = elementslist.trim();
}
...
function makeNine() {
  const form3 = document.forms[2].elements;
  let elementslist;
  for (let element of form3) {
    const elementName = element.getAttribute("name");
    elementslist += ` ${elementName} `;
  }
  paragraphNine.textContent = elementslist.trim();
}
...
function makeTen() {
  ...
  const form4btn = form4.elements.fourthName;
  paragraphTen.textContent = form4btn.value;
}
...
function makeEleven() {
  const form1 = document.forms[0];
  const form1Select = form1.elements.firstSelect;
  let optionsValues;
  for (let option of form1Select) {
